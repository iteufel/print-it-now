...
#define PIN_BIND(field, symbol)                                     \
  ...
  const Binding bindings[] = {
      ...
      PIN_BIND(CopyDestInfo, "cupsCopyDestInfo"),
      PIN_BIND(FreeDestInfo, "cupsFreeDestInfo"),
      PIN_BIND(FindDestSupported, "cupsFindDestSupported"),
      PIN_BIND(LocalizeDestValue, "cupsLocalizeDestValue"),
      PIN_BIND(IppGetCount, "ippGetCount"),
      PIN_BIND(IppGetString, "ippGetString"),
